        ...
        <section class="store-cart">
            <div class="container">
                    ...
                    <div class="col-12 table-responsive">
                        <table class="table table-borderless table-cart">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 20%;">
                                        <img src="images/product-cart-1.jpg" alt="product-cart-1" class="cart-image" />
                                    </td>
                                    <td style="width: 35%;">
                                        <div class="product-title">Strawberry</div>
                                ...
                                <tr>
                                    <td style="width: 20%;">
                                        <img src="images/product-cart-2.jpg" alt="product-cart-2" class="cart-image" />
                                    </td>
                                    <td style="width: 35%;">
                                        <div class="product-title">Bubuk Makettivv</div>
                                        <div class="product-subtitle">by Arya Wardana</div>
                                    </td>
                                    <td style="width: 35%;">
                                ...
                                <tr>
                                    <td style="width: 20%;">
                                        <img src="images/product-cart-3.jpg" alt="product-cart-3" class="cart-image" />
                                    </td>
                                    <td style="width: 35%;">
                                        <div class="product-title">Durian</div>
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="col-12">
                        <h2 class="mb-1">Payments Informations</h2>
                    </div>
                </div>
